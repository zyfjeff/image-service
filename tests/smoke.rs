...
#[test]
fn integration_test_hot_upgrade_with_fusedev() {
    ...
    snapshotter.take_over(&new_nydusd.api_sock).unwrap_or(());
    ...
    snapshotter.take_over(&new_nydusd.api_sock).unwrap();
...
#[test]
fn integration_test_hot_upgrade_with_rafs_mount() {
